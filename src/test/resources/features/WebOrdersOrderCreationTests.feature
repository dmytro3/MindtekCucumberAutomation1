...
Feature: Validating calculate and order creation functionalities
  ...
  Scenario Outline: Validating create order functionality
    ...
    Examples:
      | product     | quantity | name        | street      | city    | state | zip   | cc               | expire date |
      | MyMoney     | 10       | John Doe    | 123 My Road | Chicago | IL    | 12345 | 1234173412341234 | 12/22       |
      | FamilyAlbum | 5        | Patel Harsh | 124 My Road | Chicago | IL    | 12345 | 1234123432341234 | 07/22       |
      | ScreenSaver | 1        | Kim Yan     | 125 My Road | Chicago | IL    | 12345 | 1234113412361234 | 03/22       |
